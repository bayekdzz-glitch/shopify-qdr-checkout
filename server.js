...
.topbar-in{max-width:1140px;margin:0 auto;padding:0 24px;display:flex;align-items:center;justify-content:between}
.logo-area{display:flex;align-items:center;gap:12px}
.logo-circle{width:36px;height:36px;background:#4f46e5;color:#fff;border-radius:8px;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:18px}
...
.sim-alert{background:#fef3c7;border:1px solid #fde68a;color:#92400e;border-radius:6px;padding:10px 14px;font-size:13px;font-weight:500;margin-bottom:16px;display:flex;align-items:center;gap:8px}
...
.ship-box{border:1px solid #3b82f6;background:#eff6ff;border-radius:8px;padding:16px;display:flex;align-items:center;justify-content:between;font-size:14px}
...
.ship-sub{font-size:12px;color:#718096;margin-top:2px}
.ship-price{font-weight:600;color:#10b981}
...
.sum-title-row{display:flex;justify-content:between;align-items:center;margin-bottom:16px}
...
.sum-line{display:flex;justify-content:between;font-size:13px;color:#4a5568;margin-bottom:10px}
.sum-line-total{display:flex;justify-content:between;align-items:baseline;font-size:20px;font-weight:700;color:#1a202c;border-top:1px solid #edf2f7;padding-top:14px;margin-top:14px}
...
<div class="wrap">
  <div class="col-form">
    <div class="block-card">
      ...
      <div class="sim-alert">⚠️ <span id="lang-sim">Mode simulation · Aucune carte réelle débitée</span></div>
...
if (t) {
  ...
  document.getElementById('lang-sim').textContent = t.sim;
